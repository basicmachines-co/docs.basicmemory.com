...
<CardGroup cols={2}>
  ...
  <Card title="get_current_project" icon="folder">
    **Get current project information**
    - Shows active project details and statistics
    - Displays entity counts and sync status
    - Useful for confirming project context
  </Card>
