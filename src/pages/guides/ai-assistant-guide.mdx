...
<CodeGroup>
<CodeTab label="By Title">
```text
memory://title
```
</CodeTab>

<CodeTab label="By Folder and Title">
```text
memory://folder/title
```
</CodeTab>

<CodeTab label="By Permalink">
```text
memory://permalink
```
</CodeTab>

<CodeTab label="Follow Relations">
```text
memory://path/relation_type/*
```
</CodeTab>

<CodeTab label="Find Relations to Target">
```text
memory://path/*/target
```
</CodeTab>
...
<Accordion>
  <AccordionItem title="Observations" defaultOpen={true}>
