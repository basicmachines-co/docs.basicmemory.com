...
<Accordion>
  <AccordionItem title="Creating knowledge">
    ```
  ...
  <AccordionItem title="Referencing existing knowledge">
    ```
  ...
  <AccordionItem title="Finding information">
    ```
  ...
  <AccordionItem title="Editing existing notes (v0.13.0)">
    ```
  ...
  <AccordionItem title="Project management (v0.13.0)">
    ```
  ...
  <AccordionItem title="File organization (v0.13.0)">
    ```
...
<Accordion>
  ...
  <AccordionItem title="Sync Issues">
    - If information seems outdated and you know it should be there, try `basic-memory reset`
    - Clears out the memory metadata cache and starts fresh
    - Use when you need to reset your project synchronization
    - Does not harm your files, everything is kept safe
    - The metadata cache is automatically restored
  </AccordionItem>

  <AccordionItem title="Strict Mode for Edit/Move Operations">
