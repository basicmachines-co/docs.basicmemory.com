...
![CLI - Cloud status output](/screenshots/cli/cloud-status.png)
![CLI - Cloud snapshot list](/screenshots/cli/cloud-snapshot-list.png)

::tip
For detailed cloud setup, sync workflows, and upload options, see the [Cloud Guide](/cloud/cloud-guide) and [Cloud Sync Guide](/cloud/cloud-sync).
::
...
![CLI - Project list](/screenshots/cli/project-list.png)
...
::warning
You need to install Basic Memory via `uv` or `pip` to use the command line tools. See the [Getting Started guide](/start-here/getting-started) for installation instructions.
::
