...
Claude: [Uses schema_validate with note_type="person"]
...
Claude: [Uses schema_diff with note_type="person"]
...
Validate notes against their schema. Pass either an `note_type` to validate all notes of that type, or an `identifier` to validate a specific note.

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `note_type` | string | One of these | Note type to validate (e.g., `person`) — validates all notes of this type |
