...
::tip
For Basic Memory Cloud, the fastest path is the web app's **Connect your agent** flow (Claude, Codex, ChatGPT, and other MCP tools) — it walks you through connecting to the hosted MCP endpoint:
