...
## Using Schemas for Consistent Documentation

As your project documentation grows, schemas help ensure that ADRs, API docs, and other structured documents follow a consistent format. Define a schema once, and both human authors and AI assistants produce notes that match.
...
With this schema in place, `bm schema validate adr` checks all your ADR notes for consistent structure, and AI assistants automatically produce well-formed decision records.

See the [Schema System](/concepts/schema-system) guide for full syntax and workflow details.
...
basic-memory tool search-notes --query "authentication system"

# Update documentation
echo "Updated authentication to support OAuth2 flows" | \
basic-memory tool write-note --title "Sprint 12 - Auth Updates" --folder "updates"
```
