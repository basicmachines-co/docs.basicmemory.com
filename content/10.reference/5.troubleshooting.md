...
**Solution:** Collapse the duplicates with a full rebuild, and avoid case-only or normalization-only renames until the fixes land:

```bash
basic-memory reindex --full -p <project>
```

See [Known issues in v0.23.0](/whats-new/v0-23-upgrade#known-issues-in-v0230) for details.
