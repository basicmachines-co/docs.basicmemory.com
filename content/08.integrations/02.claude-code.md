...
::steps
### Sign Up
Create your account at [basicmemory.com](https://basicmemory.com/?utm_source=docs&utm_medium=docs&utm_campaign=claude-code).
...
::tip
The [Cloud Guide](/cloud/cloud-guide) covers the rest of cloud — web app, CLI, snapshots, and migration. For problems, see [Troubleshooting](/reference/troubleshooting).
::
...
- Look for errors in `~/.basic-memory/basic-memory.log`
...
---
Full reference for every Basic Memory tool.
::
...
---
Understand SessionStart, PreCompact, checkpoint, capture, and hook health behavior.
::
