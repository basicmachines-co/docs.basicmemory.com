...
You should see the installed version printed. If it's older than the [latest release](https://github.com/basicmachines-co/basic-memory/releases), run `bm update`.
