...
All tools support `output_format="text"` (human-readable, the default) and `output_format="json"` (machine-readable) — see the [MCP Tools Reference](/reference/mcp-tools-reference) for details.
