...
Owners, admins, and user admins invite people by email from **Settings → Members**.
...
Enter the person's email address and choose a role. You can assign any role at or below your own — Owner is never an invite option. They'll receive an email with an invitation link.
