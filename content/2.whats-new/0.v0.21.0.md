...
The headline of this release. When you work with a team, your projects can live in a shared cloud workspace that everyone on the team can read and write — alongside your own personal workspace.

Before v0.21.0, that experience was uneven: depending on which tool or command you used, your AI assistant might see only your personal projects, only the workspace it happened to be in, or all of them. v0.21.0 makes project and workspace routing consistent everywhere, so your assistant reliably reaches the right project no matter which workspace it lives in.
