...
Works with Claude Desktop, Claude Code, Cursor, Windsurf, and other AI tools that support markdown-based skill files. `npx` ships with Node.js — if you don't have it, [install Node.js](https://nodejs.org/en/download) first.

## Using a skill

Skills activate on their own when your request matches — or name one directly:
