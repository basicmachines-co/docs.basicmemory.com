...
|---------|-----------|----------|
| `bm cloud bisync` | Local ↔ Cloud | Two-way sync (recommended) |
| `bm cloud sync` | Local → Cloud | One-way, make cloud match local |
| `bm cloud check` | Verify | Check if files match |
