...
This lets you keep a hybrid setup where some projects stay local and others use cloud. See [Local & Cloud Routing](/cloud/routing) for the full routing model, priority levels, and common configurations.
