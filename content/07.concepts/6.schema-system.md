...
::docs-video{src="/videos/docs-schema-system.mp4" poster="/videos/posters/docs-schema-system.png" alt="Schema validation catching a bad record, fixed with one sentence"}
::
