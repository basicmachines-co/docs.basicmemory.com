...
::docs-video{src="/videos/docs-snapshots.mp4" poster="/videos/posters/docs-snapshots.png" alt="Creating a snapshot, deleting a note, and restoring it from the snapshot"}
::
