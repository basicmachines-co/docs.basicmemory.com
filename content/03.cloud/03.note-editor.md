...
::video-loop{src="/videos/docs-note-editor.mp4" alt="Switching between the three editing modes"}
::
...
::video-loop{src="/videos/docs-frontmatter.mp4" alt="Showing and editing a note's frontmatter"}
::
...
::video-loop{src="/videos/docs-command-palette.mp4" alt="The command palette"}
::
