...
::docs-video{src="/videos/docs-file-history.mp4" poster="/videos/posters/docs-file-history.png" alt="Opening File history and restoring an earlier version of a note"}
::
...
::docs-video{src="/videos/docs-snapshots.mp4" poster="/videos/posters/docs-snapshots.png" alt="Creating a snapshot and restoring a deleted note from it"}
::
