...
::tip
You can store your knowledge at any location. `~/basic-memory` is the default project location. See [Getting Started](/local/getting-started#choosing-where-your-notes-are-saved) for more information.
::
